...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F7F2EA] text-[#1F1F1F] overflow-hidden">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden bg-[#EFE7DB]/30">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#F7F2EA]/80 via-[#F7F2EA]/40 to-[#F7F2EA] z-10 pointer-events-none" />
        </div>

        {/* Content */}
        <div className="relative z-20 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
          <span className="text-[10px] uppercase tracking-[0.4em] text-[#C8A96B] font-bold mb-4">BEHIND THE LENS</span>
          <h1 className="font-editorial text-4xl sm:text-7xl font-bold tracking-tight text-[#1F1F1F] uppercase leading-none mb-6">
            The Studio Story
          </h1>
          <p className="text-[#5C4435] text-xs sm:text-sm tracking-[0.18em] max-w-2xl leading-relaxed font-light">
      ...
      <section className="py-24 relative z-10 border-t border-[#5C4435]/10 bg-[#F7F2EA]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <h2 className="font-editorial text-3xl sm:text-5xl font-bold uppercase tracking-tight leading-tight text-[#1F1F1F]">
                Every Frame Tells A Story.
              </h2>
              <div className="w-16 h-[1px] bg-[#C8A96B] my-2" />
              <p className="text-[#5C4435] text-xs sm:text-sm leading-relaxed tracking-wide font-light">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                <div className="flex gap-4 items-start bg-[#EFE7DB]/40 border border-[#5C4435]/15 p-5 rounded-sm">
                  <Camera className="h-5 w-5 text-[#C8A96B] shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-bold text-[#1F1F1F] mb-1">Fine Art Framing</h4>
                    <p className="text-[#5C4435]/70 text-[11px] leading-relaxed">Observational captures focusing on light, gestures, and environment.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start bg-[#EFE7DB]/40 border border-[#5C4435]/15 p-5 rounded-sm">
                  <Users className="h-5 w-5 text-[#C8A96B] shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-bold text-[#1F1F1F] mb-1">Elite Directors</h4>
                    <p className="text-[#5C4435]/70 text-[11px] leading-relaxed">Collaborative scripting and styling assistance before production.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative aspect-[3/4] overflow-hidden border border-[#5C4435]/15 rounded-sm shadow-2xl group">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#1F1F1F]/90 via-transparent to-transparent z-10" />
      ...
      {/* 3. Stats Summary Row */}
      <section className="py-20 bg-[#EFE7DB] border-y border-[#5C4435]/15 relative z-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 text-center">
            {stats.map((s, idx) => (
              <div key={idx} className="flex flex-col items-center">
                <span className="block text-4xl sm:text-5xl font-bold text-[#C8A96B] font-editorial mb-2">{s.val}</span>
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#5C4435]/70 font-light">{s.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* 4. Chief Bio */}
      <section className="py-32 relative z-10 bg-[#F7F2EA]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            
            {/* Artist Image */}
            <div className="lg:col-span-5 relative aspect-[4/5] overflow-hidden border border-[#5C4435]/15 rounded-sm lg:order-2 shadow-2xl group">
              <img
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 lg:order-1">
              ...
              <h2 className="font-editorial text-3xl sm:text-5xl font-bold uppercase tracking-tight text-[#1F1F1F]">
                Devan Singh
              </h2>
              <div className="w-16 h-[1px] bg-[#C8A96B] my-2" />
              <p className="text-[#5C4435] text-xs sm:text-sm leading-relaxed tracking-wide font-light">
              ...
              <p className="text-[#1F1F1F]/90 text-xs sm:text-sm leading-relaxed tracking-wide font-light italic border-l-2 border-[#C8A96B] pl-6 my-2">
              ...
              <div className="flex flex-wrap gap-6 mt-4">
                <div className="flex items-center gap-2.5 bg-[#EFE7DB]/60 border border-[#5C4435]/15 px-4 py-2 rounded-sm">
                  <Award className="h-4.5 w-4.5 text-[#C8A96B]" />
                  <span className="text-[10px] uppercase tracking-[0.15em] text-[#1F1F1F]/80 font-bold">WPA Awardee</span>
                </div>
                <div className="flex items-center gap-2.5 bg-[#EFE7DB]/60 border border-[#5C4435]/15 px-4 py-2 rounded-sm">
                  <ShieldCheck className="h-4.5 w-4.5 text-[#C8A96B]" />
                  <span className="text-[10px] uppercase tracking-[0.15em] text-[#1F1F1F]/80 font-bold">Secure Delivery</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 relative z-10 border-t border-[#5C4435]/10 bg-[#EFE7DB]/30">
        <div className="glass-panel p-12 md:p-16 text-center rounded-sm max-w-4xl mx-auto flex flex-col items-center border border-[#5C4435]/15 shadow-2xl relative overflow-hidden bg-[#F7F2EA]/90">
          <Sparkles className="h-10 w-10 text-[#C8A96B] mb-6 animate-pulse z-10" />
          <h2 className="font-editorial text-3xl sm:text-4xl font-bold uppercase mb-4 text-[#1F1F1F] z-10">Are You Ready to Begin?</h2>
          <p className="text-[#5C4435] text-xs sm:text-sm tracking-wide max-w-md mb-8 leading-relaxed font-light z-10">
            Bookings are highly limited to keep post-production quality premium. Get in touch to schedule your pre-production session.
          </p>
          <Link
            href="/book"
            className="text-xs uppercase tracking-[0.2em] bg-[#1F1F1F] text-[#F7F2EA] font-semibold py-4.5 px-10 rounded-sm hover:bg-[#C8A96B] hover:text-[#1F1F1F] transition-all flex items-center gap-2.5 group z-10 shadow-md"
          >
