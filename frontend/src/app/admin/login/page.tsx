...
import { Camera, Lock, Mail, ArrowLeft, ArrowRight, AlertCircle, ShieldCheck, Sun, Moon } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-[var(--background)] flex flex-col justify-between py-12 px-6 transition-colors duration-500 text-[var(--foreground)]">
      ...
      <div className="mx-auto w-full max-w-md my-auto">
        <div className="glass-panel p-8 sm:p-10 rounded-sm border border-[#D4A44B]/30">
          <div className="text-center mb-8">
            <ShieldCheck className="h-10 w-10 text-[#D4A44B] mx-auto mb-3" />
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#D4A44B] font-semibold">Studio management</span>
            <h1 className="font-editorial text-3xl font-bold uppercase mt-2 text-[var(--foreground)]">Admin Portal</h1>
            <p className="text-[var(--foreground)]/45 text-[11px] mt-2 leading-relaxed">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <label className="block text-[10px] uppercase tracking-[0.15em] text-[var(--foreground)]/50 mb-2 font-semibold">System Email Address</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[var(--input-bg)] border border-[var(--border-color)] focus:border-[#D4A44B] text-[var(--foreground)] py-3 pl-10 pr-4 rounded-sm text-xs focus:outline-none placeholder-[var(--foreground)]/30 transition-colors"
                />
              </div>
            </div>

            <div>
              <label className="block text-[10px] uppercase tracking-[0.15em] text-[var(--foreground)]/50 mb-2 font-semibold">System Key Pass</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[var(--foreground)]/45">
